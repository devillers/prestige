      ...
      <div key={idx} className="bg-white p-4 rounded shadow">
        {service.image ? (
          <img
            src={service.image}
            alt={service.title}
            className="w-full h-40 object-cover rounded mb-4 transition-transform duration-500 hover:scale-105"
          />
        ) : (
        ...
        <h2 className="text-xl text-center font-thin mb-4"> {decodeHTML(service.title)}</h2>
