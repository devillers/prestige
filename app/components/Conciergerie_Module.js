...
export default function ServiceSection() {
  ...
  return (
    <section className="bg-neutral-50 text-gray-800 ">
      <div className="max-w-6xl mx-auto grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 gap-2 mb-12">
        {/* Paragraphe 1 */}
        ...
        {images.map((img, i) => (
          ...
          >
            ...
            <div className="absolute inset-0 bg-gray-900/80 select-none opacity-0 group-hover:opacity-100 transition-opacity duration-300 z-10 flex items-center justify-center px-2 text-center">
              <span className="text-white text-sm font-thin tracking-wide">
                {img.text}
              </span>
            </div>
          </div>
